...
// Main macro
// ======================================================================
void FitMass1Bin_Expo3_Ratio(const char* filename = "/media/takuma/ESD-EAWA/Data/UPCcandMuon/0325/AnalysisResults.root")
{
  gStyle->SetOptStat(0);
  int fontCode = 42;
  ...
  TLegend* legend = new TLegend(0.65, 0.30, 0.90, 0.55);
  ...
  c1->SaveAs("Mass_Fit_1Bin_Expo3_Ratio.png");
