...
// Main macro
// ======================================================================
void FitMass6Bins_Expo3_Ratio(const char* filename = "/media/takuma/ESD-EAWA/Data/UPCcandMuon/0325/AnalysisResults.root")
{
  gStyle->SetOptStat(0);
  int fontCode = 42;
  ...
  TCanvas* c1 = new TCanvas("c1", "Fit Invariant Mass 6 Bins with Ratio", 1100, 1600);
  ...
  for (int i = 0; i < 6; ++i) {
    cfg.current_bin = i;
    c1->cd(i + 1);
    TPad* pad1 = new TPad(Form("pad1_%d", i), "pad1", 0, 0.3, 1, 1.0);
    ...
    TPad* pad2 = new TPad(Form("pad2_%d", i), "pad2", 0, 0.0, 1, 0.3);
  ...
  c1->SaveAs("Mass_Fit_6Bins_Expo3_Ratio.png");
