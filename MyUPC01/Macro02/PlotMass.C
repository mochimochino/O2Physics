...
void PlotMass(const char* filename = "/media/takuma/ESD-EAWA/Data/UPCcandMuon/MC/GlobalMuon/ResolutionAndEfficiency/15697/jpsi-coh.root")
{
  gStyle->SetOptStat(0);
  ...
  TH2D* h2 = (TH2D*)f->Get("upc-muon-analysis/registry/hPairMassResoVsMassMC");
  if (!h2) {
