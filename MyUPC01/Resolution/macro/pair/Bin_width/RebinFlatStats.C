...
void RebinFlatStats(
  ...
  const TString outputFile = "/media/takuma/ESD-EAWA/Data/UPCcandMuon/MC/GlobalMuon/ResolutionAndEfficiency/15697/Coherent/flatstats/4bin02/Step2_Rebinned.root",
  int nTargetBins = 4,
  double xMin = 0.0,
  double xMax = 0.02)
{
