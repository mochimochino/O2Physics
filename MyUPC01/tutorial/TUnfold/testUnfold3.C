...
void testUnfold3()
{
  ...
  static Double_t triggerParm_DATA[] = {
    8.0, // threshold is 8 GeV
    4.0, // width is 4 GeV
  ...
  static Double_t triggerParm_MC[] = {
    8.0, // threshold is 8 GeV
    4.0, // width is 4 GeV
  ...
  for (Int_t i = 1; i <= nGen; i++) {
    ...
    Double_t data_bgr = data - scale_bgr * (histBbbBgr1->GetBinContent(i) + histBbbBgr2->GetBinContent(i) + histBbbBgrPt->GetBinContent(i));
    Double_t errData_bgr = TMath::Sqrt(errData * errData +
    ...
    Double_t errData_total_bbb =
      TMath::Sqrt(errData_statbgr_bbb * errData_statbgr_bbb + shift_sys * shift_sys);
    ...
    std::cout << TString::Format("%3d %5.0f %8.1f +/-%5.1f +/-%5.1f +/-%5.1f (unfolding)",
                                 i, histDataTruth->GetBinContent(i), data_unfold,
                                 errData_stat_unfold, TMath::Sqrt(errData_statbgr_unfold * errData_statbgr_unfold - errData_stat_unfold * errData_stat_unfold),
                                 TMath::Sqrt(errData_total_unfold *
                                               errData_total_unfold -
                                             errData_statbgr_unfold *
                                               errData_statbgr_unfold))
              << "\n";
    std::cout << TString::Format("          %8.1f +/-%5.1f +/-%5.1f +/-%5.1f (bin-by-bin)",
                                 data_bbb, errData_stat_bbb, TMath::Sqrt(errData_statbgr_bbb * errData_statbgr_bbb - errData_stat_bbb * errData_stat_bbb),
